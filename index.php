...
<body id="body">
  ...
  <div id="wrapper">
        ...
        <div id="surface-wrapper" class="hidden screens inside">
          ...
          <div id="surface-canvas">
            <ul id="helpers" class="surface">
              <li id="helper-7">
                <span><div class="triangle"></div>Поверхность, на которую художник наносит изображение, называется основой. С давних времен для этого служили самые разные материалы: камень и дерево, слоновая кость и специально подготовленная телячья кожа, бумага и листья папируса. А знаешь ли ты, что самую настоящую картину можно нарисовать также на картонной коробке, обоях или даже на школьной доске?</span>
              </li>
            </ul>
        ...
        <div id="painting-wrapper" class="screens inside">
          ...
          <ul id="helpers">
            <li id="helper-8">
              <span><div class="triangle"></div>Современные художники постоянно экспериментируют! Создавая свои картины, они используют яркие синтетические краски, а также самые неожиданные инструменты и материалы. Но такой удивительной «палитры» точно нет ни у одного из них!</span>
            </li>
          </ul>
        ...
        <div id="filters-wrapper" class="screens inside">
          <div id="wand">
            <ul id="helpers">
                <li id="helper-9">
                  <span><div class="triangle"></div>В таком деле как творчество не обходится без волшебства – это подтвердит любой художник. Главное, вовремя остановиться!</span>
                </li>
            </ul>
          </div>
        ...
        <div id="museum-wrapper" class="screens">
          <ul id="helpers">
            <li id="helper-11"><span><div class="triangle"></div><p>Картина должна быть хорошо видна, поэтому для освещения экспонатов в музее используют специальные лампы. Свет – важный элемент любой выставки, он помогает создать подходящее настроение.</p></span></li>
            <li id="helper-12"><span><div class="triangle"></div><p>Пустые поверхности стен в музее служат фоном для экспонатов, позволяют нашим глазам отдыхать, а мыслям переключаться. Картины современных художников часто вешают на стены, выкрашенные в нейтральный, белый цвет – их словно помещают внутрь «белого куба», где ничто не отвлекает внимание.</p></span></li>

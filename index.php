...
<body id="body">
  ...
  <div id="wrapper">
        ...
        <div id="surface-wrapper" class="hidden screens inside">
          ...
          <div id="surface-canvas">
            <ul id="helpers" class="surface">
              <li id="helper-7" class="interact"><span>Поверхность, на которую художник наносит изображение, называется основой. С давних времен для этого служили самые разные материалы: камень и дерево, слоновая кость и специально подготовленная телячья кожа, бумага и листья папируса. А знаешь ли ты, что самую настоящую картину можно нарисовать также на картонной коробке, обоях или даже на школьной доске?</span></li>
            </ul>
        ...
        <div id="museum-wrapper" class="screens">
          <ul id="helpers">
            <li id="helper-11" class="interact"><span><p>Картина должна быть хорошо видна, поэтому для освещения экспонатов в музее используют специальные лампы. Свет – важный элемент любой выставки, он помогает создать подходящее настроение.</p></span></li>
            <li id="helper-12" class="interact"><span><p>Пустые поверхности стен в музее служат фоном для экспонатов, позволяют нашим глазам отдыхать, а мыслям переключаться. Картины современных художников часто вешают на стены, выкрашенные в нейтральный, белый цвет – их словно помещают внутрь «белого куба», где ничто не отвлекает внимание.</p></span></li>
            <li id="helper-13" class="interact"><span class="up"><p>Это стул смотрителя, который в течение всего дня следит за порядком на выставке. Не обижайся, если смотритель попросит тебя не трогать экспонаты. Искусство – вещь хрупкая и требует бережного отношения.</p></span></li>
            <li id="helper-14" class="interact"><span class="up"><p>Современное искусство любит загадывать загадки. Как ты думаешь, это музейный экспонат или обыкновенный огнетушитель?</p></span></li>

  ...
  <div id="wrapper">
        ...
        <div id="filters-wrapper" class="screens inside">
          <div id="wand">
            <ul id="helpers">
                <li id="helper-9">
                  <span class="down"><div class="triangle"></div>В таком деле как творчество не обходится без волшебства – это подтвердит любой художник. Главное, вовремя остановиться!</span>
                </li>
            </ul>
          </div>

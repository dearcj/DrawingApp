  ...
  <div id="wrapper">
        <div id="index-wrapper" class="screens">
          ...
          <ul id="helpers" class="index">
            <li id="helper-1" class="home-helpers"><span class="down"><p>Дом, в котором живёт наш музей, был построен в 18 веке купцом для своей семьи. А ещё с тех пор в этом доме была мужская гимназия, общежитие милиционеров, больница и много других интересных жильцов. В 1999 году в доме поселился музей. Мы надеемся, что в будущем с искусством всё будет хорошо!</p></span></li>
            <li id="helper-2" class="home-helpers"><span class="down"><p>У нашего музея есть еще 3 здания - Ермолаевский, 17, Гоголевский, 10, Тверской бульвар, 9</p></span></li>
            <li id="helper-3" class="home-helpers"><span class="up"><p>Во дворе музея тоже живёт искусство. Тут можно погулять и посмотреть на скульптуры из разных стран. У нас есть свой небольшой кусочек Эйфелевой башни и солнца.</p></span></li>
            <li id="helper-4" class="home-helpers"><span class="up"><p>А основатель музея Зураб Церетели не только подарил музею свою коллекцию, но и придумал для него необычный вход с приветами из разных эпох.</p></span></li>
            <li id="helper-5" class="home-helpers"><span class="up"><p>Ты можешь приходить в музей каждый день с 12 до 18:00. У музея всего один выходной в месяц (третий понедельник). В этот день сотрудники наводят в музее порядок, а искусство отдыхает от зрителей.</p></span></li>
            <li id="helper-6" class="home-helpers"><span><p>Тебе предстоит создать новую современную картину!</p></span></li>
            <li id="helper-6s" class="home-helpers"><span><p>Здесь будут выставлены твои картины</p></span></li>
          </ul>

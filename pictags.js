...
var picTags = [
	...
	},
	{
		...
		description: 'На дверях мы привыкли видеть номера квартир или таблички кабинетов, но мало кто использует деревянную дверь как поверхность для рисования. А ведь это готовая доска для картины! У нее есть ровные края и даже несколько рамок, внутри которых можно создавать изображения.<br>Было время, когда художники писали красками преимущественно на дереве, а вход в дом украшали деревянными вывесками, рассказывающими о назначении здания или о его владельце. Что же таится за этой дверью – мастерская художника, наблюдательный пункт астронома или волшебная комната мага?'
	},
	{

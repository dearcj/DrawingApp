...
jQuery(document).ready(function($) {
	...
	function helpersTextProperties() {
		...
		$('ul#helpers li#helper-12 span').css({left: -spanWidth/2 + 'px', top: -spanTopPos + 'px'});
		$('ul#helpers li#helper-13 span').css({left: -spanWidth/2 + 'px', top: spanTopPos * 2.3 + 'px'});
		$('ul#helpers li#helper-14 span').css({left: -spanWidth/2 + 'px', top: spanTopPos * 2.1 + 'px'});
		$('ul#helpers li#helper-15 span').css({left: -spanWidth/2 + 'px', top: spanTopPos * 2.5 + 'px'});

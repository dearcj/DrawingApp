...
jQuery(document).ready(function($) {
	...
	function helpersTextProperties() {
		...
		$('ul#helpers li#helper-3 span.up').css({left: -spanWidth + 'px', top: spanTopPos * 5.9 + 'px'});
		$('ul#helpers li#helper-4 span.up').css({left: -spanWidth/2 + 'px', top: spanTopPos * 5.1 + 'px'});

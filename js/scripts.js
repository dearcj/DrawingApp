...
jQuery(document).ready(function($) {
	...
	function setRandomImgs() {
		...
		for (var i = 0; i < 3; i++) {
			...
			$('ul.paintings.left-side a:nth-child(' + (i + 1) + ') li:hover').css('background', 'linear-gradient(0deg, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url(' + leftAbsPath + ') no-repeat');
			...
			$('ul.paintings.right-side a:nth-child(' + (i + 1) + ') li:hover').css('background', 'linear-gradient(0deg, rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url(' + rightAbsPath + ') no-repeat');
		}
	}

...
jQuery(document).ready(function($) {
	...
	$('#button-2').on(window.eventType, function(event) {
		$('#index-wrapper').fadeOut(500).addClass('hidden');
		$('#performance-wrapper').fadeIn(500).removeClass('hidden').animate({'opacity': 1}, 200);
		openPage('performance');
	});

	$('#button-5').on(window.eventType, function(event) {
		$('#index-wrapper').fadeOut(500).addClass('hidden');
		$('#interpretation-wrapper').fadeIn(500).removeClass('hidden').animate({'opacity': 1}, 200);
		openPage('interpretation');
	});

	$('#button-6').on(window.eventType, function(event) {
		$('#index-wrapper').fadeOut(500).addClass('hidden');
		$('#mediaart-wrapper').fadeIn(500).removeClass('hidden').animate({'opacity': 1}, 200);
		openPage('media-art');
	});
	...
	$('li.installation').on(window.eventType, function(event) {
		...
		$('#installation-wrapper').fadeIn(500).removeClass('hidden').animate({'opacity': 1}, 200);
		openPage('installation');
	});
